...
public class BlockRuneJera extends BlockFlower {

	protected BlockRuneJera(int par1, Material par2Material) {
		super(par1, Material.plants);
		float var3 = 0.5F;
		float var4 = 0.015625F;
		this.setTickRandomly(true);
		this.setBlockBounds(0.5F - var3, 0.0F, 0.5F - var3, 0.5F + var3, var4, 0.5F + var3);
		this.setUnlocalizedName(Strings.BLOCKRUNE_JERA);
		...
		blockIcon = iconRegister.registerIcon(Reference.MOD_ID.toLowerCase() + ":" + Strings.BLOCKRUNE_JERA);
		}

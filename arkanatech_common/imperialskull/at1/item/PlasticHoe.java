...
public class PlasticHoe extends ItemHoe {
    ...
    public PlasticHoe(int id, EnumToolMaterial par2EnumToolMaterial) {
        super(id, par2EnumToolMaterial);
        this.setUnlocalizedName(Strings.PLASTIC_HOE);
    ...
    public void registerIcons(IconRegister iconRegister) {
        ...
        itemIcon = iconRegister.registerIcon(Reference.MOD_ID.toLowerCase() + ":" + Strings.PLASTIC_HOE);

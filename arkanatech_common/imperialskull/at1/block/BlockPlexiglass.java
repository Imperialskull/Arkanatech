...
public class BlockPlexiglass extends BlockBreakable {
    ...
    public BlockPlexiglass (int id, Material material, Boolean par3){
        ...
        this.setUnlocalizedName(Strings.PLEXIGLASS_NAME);
    }
    ...
    public void registerIcons(IconRegister iconRegister){
        ...
        for(int i = 0; i < 16; ++i){
            icons[i] = iconRegister.registerIcon(Reference.MOD_ID.toLowerCase()+ ":"+Strings.PLEXIGLASS_NAME + Strings.COLOURS[i]);
        }
    }

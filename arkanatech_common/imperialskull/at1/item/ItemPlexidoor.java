...
public class ItemPlexidoor extends Item {
        ...
        public ItemPlexidoor(int i) {
            super(i);
            maxStackSize = 1;
            this.setUnlocalizedName(Strings.PLEXIDOOR_ITEM_NAME);
        ...
        public void registerIcons(IconRegister iconRegister){
            itemIcon = iconRegister.registerIcon(Reference.MOD_ID.toLowerCase() + ":" + Strings.PLEXIDOOR_ITEM_NAME);
        }
        @Override

...
public class BlockPlexidoor extends BlockBreakable
{
    ...
    public BlockPlexidoor(int par1, Material par2Material, boolean par3)
    {
        ...
        this.setUnlocalizedName(Strings.PLEXIDOOR_NAME);
        this.setHardness(1);
    ...
    public void registerIcons(IconRegister iconRegister){
      blockIcon = iconRegister.registerIcon(Reference.MOD_ID.toLowerCase()+ ":"+Strings.PLEXIDOOR_NAME);
    }
...
{
return ArkaneItems.itemPlexidoor.itemID;}

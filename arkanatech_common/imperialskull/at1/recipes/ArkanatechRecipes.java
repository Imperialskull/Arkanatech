    ...
    //ItemStack plasticBlock = new ItemStack(ArkaneBlocks.plastic,1,0);
       ...
       //SHAPELESS RECIPES
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ArkaneBlocks.plexiglow,1,0), 
               new ItemStack(ArkaneBlocks.plexiglass,1,0),new ItemStack(Item.lightStoneDust,1) );
        ...
        for (int ix = 0; ix < 16; ix++) {
            GameRegistry.addShapelessRecipe(new ItemStack(ArkaneBlocks.plexiglass, 1, BlockCloth.getDyeFromBlock(ix)), new Object[] {new ItemStack(Item.dyePowder, 1, ix), new ItemStack(ArkaneBlocks.plexiglass, 1, 0)});
            GameRegistry.addShapelessRecipe(new ItemStack(ArkaneBlocks.plexiglow, 1, BlockCloth.getDyeFromBlock(ix)), new Object[] {new ItemStack(Item.dyePowder, 1, ix), new ItemStack(ArkaneBlocks.plexiglow, 1, 0)});
            GameRegistry.addShapelessRecipe(new ItemStack(ArkaneBlocks.plastic, 1, BlockCloth.getDyeFromBlock(ix)), new Object[] {new ItemStack(Item.dyePowder, 1, ix), new ItemStack(ArkaneBlocks.plastic, 1, 0)});
